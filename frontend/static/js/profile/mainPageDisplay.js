 ...
 * @returns {Promise<object|null>} A Promise that resolves with the fetched profile data object on success, or null on failure.
 */
export async function fetchAndRenderMainPageData() {
    ...
    try {
        ...
        if (data.status === 'success') {
            ...
            // Explicitly return the fetched data
                return data;
            ...
            return null; // Return null on API status not success
        }
    } catch (error) {
