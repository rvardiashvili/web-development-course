...
let postMediaInput = document.getElementById('post-media');
let postVisibilitySelect = document.getElementById('post-visibility');
let postMessageContainer = document.getElementById('post-messages');

// New DOM elements for the modal
let postCreationModal = document.getElementById('post-creation-modal');
 ...
 */
async function handlePostSubmit(event, refreshPostsCallback, contextId=null) {
    ...
    if (contextId) {
        formData.append('group_id', contextId);
    }
 ...
 */
export function setupPostCreationListeners(refreshPostsCallback, contextId=null) {
    if (postForm) {
        postForm.addEventListener('submit', (event) => handlePostSubmit(event, refreshPostsCallback, contextId));
    } else {
        console.warn("Post creation form (id='post-form') not found.");
    }
}

export function setupPostCreationModule(contextId=null){
    postForm = document.getElementById('post-form');
    postContentInput = document.getElementById('post-content');
    postMediaInput = document.getElementById('post-media');
    postVisibilitySelect = document.getElementById('post-visibility');
    postMessageContainer = document.getElementById('post-messages');
    postCreationModal = document.getElementById('post-creation-modal');
    ...
    setupPostCreationListeners(refreshPostsCallback, contextId);
